...
pub struct ExpectedInfo {
  name: String,
  content: String,
  config: Option<modern_swc_plugins_collection::types::TransformConfig>,
}
...
where
  H: FixtureTesterHook,
{
  pub config: modern_swc_plugins_collection::types::TransformConfig,
  pub hooks: H,
...
pub trait FixtureTesterHook {
  fn on_before_resolve(
    &mut self,
    _fixture_path: &Path,
    _config: &mut modern_swc_plugins_collection::types::TransformConfig,
  ) {
  }
  ...
  T: FixtureTesterHook,
{
  fn on_before_resolve(
    &mut self,
    fixture_path: &Path,
    config: &mut modern_swc_plugins_collection::types::TransformConfig,
  ) {
    match self {
  ...
  H: FixtureTesterHook,
{
  ...
  pub fn new(
    config: modern_swc_plugins_collection::types::TransformConfig,
    hooks: H,
  ...
  pub fn run_test<'a, D: Display>(
    ...
    let res = modern_swc_plugins_core::transform(
